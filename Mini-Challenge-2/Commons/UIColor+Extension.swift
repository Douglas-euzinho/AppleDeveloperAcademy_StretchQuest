    ...
    static func getColorBy(category: StretchType) -> RingColorAttributes {
        ...
        case .posture:
            ...
            return RingColorAttributes.init(
                ...
                shadowColor:UIColor(red: 155/255,  green: 237/255, blue: 157/255, alpha: 0.6),
...
//                pulse:      UIColor(red: 175/255, green: 238/255, blue: 250/255, alpha: 0.6))
        ...
        case .flexibility:
            //Blue Color
            return RingColorAttributes.init(
                shapeColor: UIColor(red: 23/255,   green: 64/255, blue: 189/255, alpha: 1),
                trackColor: UIColor(red: 115/255, green: 161/255, blue: 229/255, alpha: 1),
                shadowColor:UIColor(red: 154/255,   green: 189/255, blue: 236/255, alpha: 0.6),
